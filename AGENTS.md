# Gema Digital Project Context

When the user starts a chat or message with the word `gema`, treat it as a request to continue this project.

Project scope:
- Gema Digital website and brand identity.
- ERP Cumbre product identity and future SaaS architecture.
- WordPress local implementation via Studio.
- Content source in `../03-Silo contenido/`.
- Logo source in `../02-Logos/`.
- Project base in this repository.
